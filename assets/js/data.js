...
DG.data = (function () {
  ...
  var roles = [
    ...
    /* 项目端角色 */
    { id: 'r4', name: '网格长', type: '默认', builtin: true, platform: 'project', projectId: 'p1', client: 'Web/APP', userIds: ['U102'], userCount: 1, updateTime: '2026-08-26 09:30', menuIds: ['m-home', 'm-grid', 'm-task', 'm-app-home', 'm-app-todo'], synced: true, canEdit: true, canDelete: false, unitName: '四川蜀道业主单位' },
    { id: 'r5', name: '现场网格员', type: '默认', builtin: true, platform: 'project', projectId: 'p1', client: 'Web/APP', userIds: ['U103'], userCount: 1, updateTime: '2026-08-26 09:30', menuIds: ['m-home', 'm-grid', 'm-patrol', 'm-app-patrol'], synced: true, canEdit: true, canDelete: false },
    { id: 'r6', name: '资料管理员', type: '自定义', builtin: false, platform: 'project', projectId: 'p1', client: 'Web', userIds: ['U104'], userCount: 1, updateTime: '2026-08-29 16:40', menuIds: ['m-task', 'm-report'], synced: false, canEdit: true, canDelete: true, unitName: 'XX监理一标' },
    { id: 'r7', name: '安全巡查员', type: '自定义', builtin: false, platform: 'project', projectId: 'p1', client: 'Web/APP', userIds: ['U105'], userCount: 1, updateTime: '2026-08-30 11:00', menuIds: ['m-patrol', 'm-danger', 'm-app-patrol'], synced: false, canEdit: true, canDelete: true, unitName: '四川蜀道业主单位' },
    { id: 'r8', name: '项目管理员', type: '管理员', builtin: true, platform: 'project', projectId: 'p1', client: 'Web/APP', userIds: ['U101'], userCount: 1, updateTime: '2026-08-26 09:25', menuIds: ['m-home', 'm-grid', 'm-task', 'm-patrol', 'm-danger', 'm-report', 'm-app-home'], canEdit: false, canDelete: false },

    /* 工地端角色 */
    { id: 'r9', name: '工地管理员', type: '管理员', builtin: true, platform: 'site', projectId: 'p1', siteId: 's1', client: 'Web/APP', alias: '工地负责人', userIds: ['U201'], userCount: 1, updateTime: '2026-08-26 10:05', menuIds: ['m-home', 'm-grid', 'm-task', 'm-app-home', 'm-app-todo'], canEdit: false, canDelete: false, source: '内置' },
    { id: 'r10', name: '网格长', type: '默认', builtin: true, platform: 'site', projectId: 'p1', siteId: 's1', client: 'Web/APP', alias: '标段网格长', userIds: ['U202'], userCount: 1, updateTime: '2026-08-27 09:00', menuIds: ['m-home', 'm-grid', 'm-task', 'm-app-todo'], canEdit: true, canDelete: false, source: '项目同步' },
    { id: 'r11', name: '现场网格员', type: '默认', builtin: true, platform: 'site', projectId: 'p1', siteId: 's1', client: 'Web/APP', alias: '', userIds: ['U203'], userCount: 1, updateTime: '2026-08-27 09:00', menuIds: ['m-home', 'm-grid', 'm-app-patrol'], canEdit: true, canDelete: false, source: '项目同步' },
    { id: 'r12', name: '班组安全员', type: '自定义', builtin: false, platform: 'site', projectId: 'p1', siteId: 's1', client: 'APP', alias: '安全员', userIds: ['U203'], userCount: 1, updateTime: '2026-08-31 15:20', menuIds: ['m-danger', 'm-app-patrol'], canEdit: true, canDelete: true, source: '工地自定义' }
  ];
